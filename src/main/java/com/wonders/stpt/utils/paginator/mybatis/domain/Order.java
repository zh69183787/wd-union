...
public class Order implements Serializable {
    ...
    /**
     * PropertyPath implements the pairing of an {@link com.wonders.stpt.utils.paginator.mybatis.domain.Order.Direction} and a property. It is used to provide input for
     *
